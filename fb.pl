#!/usr/bin/perl
#
# Tool: Anonymoux Bruter
# Author: Anonymoux Minou
# Contact: aymankhalfatni90@gmail.com
# Code date: 21 September 2016
# 
#
# Description:
# Anonymoux Cracker is a password cracking tool written in perl to perform a dictionary-based attack on a specific Facebook user through HTTPS.
#
# Usage:
# perl Anonymoux-Bruter.pl login wordlist
...
#
# Demo:
# perl anonymoux-Bruter.pl Facebooklogin@facebook.com wordlist.lst 
#
# --- anonymoux-Bruter Facebook password cracking tool
# --- By Anonymoux Minou
# --- www.facebook.com/Anonymouxminou
#
...
system('clear');
print "\n+++ Anonymoux-Bruter Facebook password Bruter\n";
print "+++ Coded by Anonymoux-Minou\n";
print "+++ www.fb.com/Anonymouxminou\n\n";
